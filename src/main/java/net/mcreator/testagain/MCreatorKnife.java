...
public class MCreatorKnife extends Elementstestagain.ModElement {
	...
	private static class ItemToolCustom extends Item {
		...
		public float getDestroySpeed(ItemStack itemstack, BlockState blockstate) {
			if (blockstate.getBlock() == MCreatorBlockOcheese.block.getDefaultState().getBlock())
				return 5f;
			return 0;
		}
		...
		public Multimap<String, AttributeModifier> getAttributeModifiers(EquipmentSlotType equipmentSlot) {
			...
			if (equipmentSlot == EquipmentSlotType.MAINHAND) {
				...
				multimap.put(SharedMonsterAttributes.ATTACK_SPEED.getName(),
						new AttributeModifier(ATTACK_SPEED_MODIFIER, "Tool modifier", 0.1, AttributeModifier.Operation.ADDITION));
			}
			return multimap;
		}
	}
