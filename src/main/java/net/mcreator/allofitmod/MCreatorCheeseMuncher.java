...
public class MCreatorCheeseMuncher extends Elementsallofitmod.ModElement {
	public static EntityType entity = null;
	@ObjectHolder("allofitmod:entitybulletcheesemuncher")
	public static final EntityType arrow = null;
	public MCreatorCheeseMuncher(Elementsallofitmod instance) {
		super(instance, 7);
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletcheesemuncher").setRegistryName("entitybulletcheesemuncher"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			biome.getSpawns(EntityClassification.AMBIENT).add(new Biome.SpawnListEntry(entity, 20, 5, 30));
		}
		...
		RenderingRegistry.registerEntityRenderingHandler(CustomEntity.class, renderManager -> {
			return new MobRenderer(renderManager, new PigModel(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("allofitmod:textures/pig-1.png.png");
				}
			};
		});
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(MCreatorBlockOcheese.block, (int) (1));
		}
